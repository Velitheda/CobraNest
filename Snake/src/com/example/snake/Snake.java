...
public class Snake {
	...
	public void setDirectionWhenTouched(Point start, Point end) {
		// Point center = new Point(snakeBody[0].getArea().centerX(),
		// snakeBody[0].getArea().centerY() );
		// int localX = x - center.x;
		// int localY = y - center.y;//translating the direction the user swiped
		// into a vector relative to the snake
